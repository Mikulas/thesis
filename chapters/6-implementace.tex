...
\section{GitLab}
    ...
    Po instalaci je automaticky zaregistrován uživatel \code{root} s přednastaveným heslem \code{CVUT_FIT}. Repozitáře jsem nenascriptoval a je potřeba je ručně vytvořit. Dále je potřeba uživateli nastavit veřejný SSH klíč, který slouží ke sprárování identity při práci s repozitáři.
