...
\section{\glstext{SaaS}: \circleci, \semaphore, \travis}
    ...
    \subsection{Praktické nasazení projektů}
        ...
        \subsubsection{Projekt 2}
            \todo{[PROGRAMOVANI] Popsat deploy projektu 2 z CircleCI, Semaphore, TravisCI}\blind[2]

        \subsubsection{Projekt 3}
            \todo{[PROGRAMOVANI] Popsat deploy projektu 3 z CircleCI, Semaphore, TravisCI}\blind[2]
