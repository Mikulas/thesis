...
\newcommand{\CgB}{\cellcolor{green!60}}
\newcommand{\CgC}{\cellcolor{green!15}}
\newcommand{\Cr}{\cellcolor{red}}
\newcommand{\CrA}{\cellcolor{red!100}}
\newcommand{\CrB}{\cellcolor{red!60}}
\newcommand{\CrC}{\cellcolor{red!15}}
...
\section{Souhrn}
    ...
    S~výjimkou GitLab jsou všechna \CI buď proprietární \glstext{SaaS} nebo zdarma, open-source a self-hosted. GitLab má odlišnou strategii a prodává licence jak pro hostovanou, tak i pro self-hosted variantu~(GitLab~\glstext{EE}).
    ...
    \subsection{Použití jednotlivých \CI}
        \begin{description}
            ...
            \item[GoCD] Funkčně stejné nebo horší než Jenkins, má menší komunitu a skoro není udržovaný. Má nevýznamně lepší \glstext{UX}.
