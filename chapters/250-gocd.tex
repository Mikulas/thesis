\section{GoCD}
    ...
    \subsection{Dostupnost}
        ...
        \todo{[PROGRAMOVANI] Jak se dělá backup/restore? Jak stabilní to je?}\blind[1]
    ...
    \subsection{Praktické nasazení projektů}
        ...
        \subsubsection{Projekt 2}
            \todo{[PROGRAMOVANI] Popsat deploy projektu 2 z GoCD}\blind[2]

        \subsubsection{Projekt 3}
            \todo{[PROGRAMOVANI] Popsat deploy projektu 3 z GoCD}\blind[2]
