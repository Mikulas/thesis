\section{Concourse}
    ...
    \subsection{Zabezpečení}
        ...
        Ve veřejné databázi \glstext{CVE} nemá Concourse moc záznamů \cite{cve-concourse}. Žádné nejsou kompletně zařazené a otagované a část z nich nemá dopočítané ani \glstext{CVSS}. Ani při hledání v repozitáři jsem nenašel žádné důležité nahlášené bezpečnostni problémy.
