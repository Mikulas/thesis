\section{Concourse}
    ...
    \subsection{Architektura Concourse, možnosti konfigurace}
        ...
        \todo{[obrazek] \url{https://concourse-ci.org/concepts.html\#component-atc}}
    ...
    \subsection{Dostupnost}
        ...
        \todo{[PROGRAMOVANI] Otestovat restore z backupu}\blind[1]
        \todo{[PROGRAMOVANI] Otestovat upgrade a říct jak stabilní concourse byl}\blind[1]
