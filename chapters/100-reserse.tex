\chapter{Rešerše}
    ...
    \section{Testování aplikací}
        ...
        Integrační testy seskupují funkctionalitu otestovanou jednotkově a ověřují, že propojení komponent dává smysl \cite{integration-tests}. Tyto testy mohou využívat externí závislosti, například databáze.
    ...
    \section{Nasazení aplikace}
        V této sekci popisuji varianty nasazení nové verze aplikace s vysokou dostupností. U porovnávaných \CICD systémů budu později zkoumat, jaké varianty nasazení podporují, případně jak obtížné je jednotlivé varianty implementovat. \todo{pridat citace}
    ...
    \section{Bezpečnost}
        V následující kapitole budu porovnávat různé \CI nástroje. Jedním z kritérií na které se zaměřím bude bezpečnost. Ani v rámci jedné organizace není žádoucí, aby všichni uživatelé viděli všechny ostatní testované projekty. Příklad z praxe jsou zaměstnanci bez podepsaného \glstext{NDA}.
